...
- [~] prepare a 50-100 image evaluation set (image export in `~/figure_project/exports/<stamp>`, `init-dataset`; export pending) — see [export-dataset.md](./export-dataset.md)
